...
router.put('/:product_id', [authMiddleware, checkRole('admin')], controllers.ProductsController.updateProduct);
router.put('/batch/price_update', [authMiddleware, checkRole('admin')], controllers.ProductsController.updatePrices);
router.delete('/:product_id', [authMiddleware, checkRole('admin')], controllers.ProductsController.onDelete);
